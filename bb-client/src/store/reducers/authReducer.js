...
export default (state = initialState, { type, payload }) => {
  switch (type) {
    ...
    case actions.CLEAN_UP_FLAG:
      return cleanUpFlag(state);
    ...
    case actions.ASSIGN_FLAG_ORG:
      return assignFlagOrg(state);

    case actions.ASSIGN_FLAG_HACKER:
      return assignFlagHacker(state);
